...
# TEST 显示列名，列唯一值
# df = pd.read_excel(os.path.join(os.getcwd(),'data', global_name + u'2015-2019.xlsx'))
...
with open(os.path.join(os.getcwd(), 'data', global_name + u'2015-2019_record.json'), 'w+', encoding='utf-8') as f:
    f.write(json.dumps(records,ensure_ascii=False, indent=4))

with open(os.path.join(os.getcwd(), 'data', global_name + u'2015-2019_moneyfund.json'), 'w+', encoding='utf-8') as f:
    f.write(json.dumps(money_funds,ensure_ascii=False, indent=4))

with open(os.path.join(os.getcwd(), 'data', global_name + u'2015-2019_other.json'), 'w+', encoding='utf-8') as f:
