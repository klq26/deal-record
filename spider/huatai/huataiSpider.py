...
# 证券代码取值范围
suppose_codes = {'name': '证券代码', 'value': ['510050', ' ', '510300', '510500', '159915', '518880', '159938','512980','512580']}
# 证券名称取值范围
suppose_names = {'name': '证券名称', 'value': ['50ETF', ' ', '300ETF', '500ETF', '创业板', '黄金ETF', '医药','传媒ETF','环保ETF']}
# 委托类别取值范围
